 ...
 *
 */
public class BreadCrumbException extends Exception implements Serializable{
	 ...
	 */
	public BreadCrumbException(Exception sourceException, String msg, Integer codErr, String ticket) {
